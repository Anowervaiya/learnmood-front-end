...
export const SimilarChallenge = () => {
  return (
    <div className="p-0 gap-0">
        ...
        <div className="text-xl mb-4 font-bold">Similar Challenge</div>
     
      <div className="space-y-4">
        {courses.map((course, index) => (
          <div key={index} className="flex gap-3 pb-4 border-b last:border-0 last:pb-0 cursor-pointer hover:bg-muted/50  rounded-lg transition-colors">
            <img
              src={course.image}
              alt={course.title}
