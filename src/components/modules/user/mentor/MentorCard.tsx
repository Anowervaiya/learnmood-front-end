      ...
      >
        <CardContent className="p-4 h-full flex flex-col justify-between">
            ...
            <Link  href={`/profile/${mentor.userId._id}`}>
                <div className="flex justify-start w-full items-center">
                  ...
                  <div className="text-start pl-5">
                    <h3 className="font-bold text-xl text-gray-900 mb-1">{mentor?.userId?.name}</h3>
                    <p className="text-sm text-gray-600 mb-4 font-medium">{mentor.education}</p>
                  </div>
                </div>
              ...
              <div className="mb-4 w-full px-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-600 text-start">{mentor.location}</span>
                </div>
              </div>
          ...
          <div>
            ...
            <Button onClick={() => handleChatData(mentor)} className="flex-1 bg-gradient-to-r  hover:cursor-pointer from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-xl shadow-md">
                <MessageCircle className="w-4 h-4 mr-2" />
                Message
              </Button>
              <Button disabled={submitting} onClick={()=>handleHireMe(mentor._id)} variant="outline" className="flex-1 border-2 hover:cursor-pointer rounded-xl">
